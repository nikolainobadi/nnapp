...
//        let mockPicker = MockSwiftPicker(permissionResult: .init(type: .ordered([false]))) // No to "Would you like to add a shortcut?"
...
//        
//        let picker = picker ?? MockSwiftPicker(permissionResult: .init(type: .ordered(permissionResponses)))
